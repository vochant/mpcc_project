...
private:
    static NativeFunction::resulttype is_linux(NativeFunction::arglist args) {
        if (args.size() > 0) {
    ...
    static NativeFunction::resulttype is_windows(NativeFunction::arglist args) {
        if (args.size() > 0) {
            return std::make_pair(NativeFunction::Result::FORMAT_ERR, std::make_shared<Error>());
        }
        #ifdef _WIN32
    ...
    static NativeFunction::resulttype is_apple(NativeFunction::arglist args) {
        if (args.size() > 0) {
            return std::make_pair(NativeFunction::Result::FORMAT_ERR, std::make_shared<Error>());
        }
        #ifdef __APPLE__
    ...
    static NativeFunction::resulttype is_android(NativeFunction::arglist args) {
        if (args.size() > 0) {
            return std::make_pair(NativeFunction::Result::FORMAT_ERR, std::make_shared<Error>());
        }
        #ifdef __ANDROID__
    ...
    static NativeFunction::resulttype is_unix(NativeFunction::arglist args) {
        if (args.size() > 0) {
            return std::make_pair(NativeFunction::Result::FORMAT_ERR, std::make_shared<Error>());
        }
        #ifdef __unix__
    ...
    static NativeFunction::resulttype posix_supported(NativeFunction::arglist args) {
        if (args.size() > 0) {
            return std::make_pair(NativeFunction::Result::FORMAT_ERR, std::make_shared<Error>());
        }
    ...
    static NativeFunction::resulttype is_debug(NativeFunction::arglist args) {
        if (args.size() > 0) {
            return std::make_pair(NativeFunction::Result::FORMAT_ERR, std::make_shared<Error>());
        }
    ...
    static NativeFunction::resulttype mpcc_version(NativeFunction::arglist args) {
        if (args.size() > 0) {
            return std::make_pair(NativeFunction::Result::FORMAT_ERR, std::make_shared<Error>());
        }
