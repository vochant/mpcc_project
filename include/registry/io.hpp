...
private:
	static NativeFunction::resulttype print(NativeFunction::arglist args) {
		for (auto i : args) {
			std::cout << i->toString();
		}
	...
	static NativeFunction::resulttype println(NativeFunction::arglist args) {
		for (auto i : args) {
			std::cout << i->toString();
		}
		std::cout << "\n";
	...
	static NativeFunction::resulttype termFormat(NativeFunction::arglist args) {
		for (auto i : args) {
